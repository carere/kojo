...
import {
  type LifecycleControlAction as ControlAction,
  type LifecycleControlRequest as ControlRequest,
  decodeLifecycleControlRequest,
  decodeLifecycleOwner,
  exactKeys,
  record,
  type UpgradeControlAction,
  type UpgradeControlRequest,
...
const requestOf = decodeLifecycleControlRequest;
