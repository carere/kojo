...
export const readme = (choices: FactoryChoices, starter: Starter): string => {
  ...
  return [
    ...
    "",
    "Three more files were written **outside** this directory, and they are the only ones:",
    "",
    "| File | What it decides |",
    "|---|---|",
    "| `.claude/skills/kojo/SKILL.md` | Routes an agent to the Kojo instructions for its task. |",
    "| `.claude/skills/kojo/operations.md` | How an agent operates the Daemon-owned Project, Workflow, Run, Gate, and Console surfaces. |",
