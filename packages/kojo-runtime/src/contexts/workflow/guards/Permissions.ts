...
/**
 * The agent's shared write list, then its own scope, then what is protected — the Factory's whole
 * directory included.
 *
 ...
 * author's list so that a Factory already stamped is covered without editing a Workflow.
 */
