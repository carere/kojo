...
const VerificationBase: Schema.Class<
  Verification,
  Schema.Struct<{
    readonly envelope: Schema.String;
    readonly ran: Schema.$Array<Schema.String>;
    readonly failed: Schema.$Array<Schema.String>;
    readonly corrections: Schema.Finite;
    readonly correctable: Schema.Boolean;
  }>,
  Record<never, never>
> = Schema.Class<Verification>("Verification")({
  /**
