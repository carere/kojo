 ...
 */
export const FileKind: Schema.Literals<readonly ["file", "directory", "other"]> = Schema.Literals([
  "file",
  "directory",
  "other",
]);
...
const FileStatBase: Schema.Class<
  FileStat,
  Schema.Struct<{
  ...
  Record<never, never>
> = Schema.Class<FileStat>("FileStat")({
  kind: FileKind,
  size: Schema.Finite,
});

/** The part of a stat a check has any business reading. */
export class FileStat extends FileStatBase {}
