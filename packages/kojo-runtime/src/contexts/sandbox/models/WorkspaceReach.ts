...
const WorkspaceReachBase: Schema.Class<
  WorkspaceReach,
  Schema.Struct<{
    readonly probe: Schema.String;
    readonly reached: Schema.Boolean;
    readonly detail: Schema.String;
  }>,
  Record<never, never>
> = Schema.Class<WorkspaceReach>("WorkspaceReach")({
 ...
 */
export class WorkspaceReach extends WorkspaceReachBase {}
